...
impl sm::TextureFormat for SurfaceFormat {
    fn id() -> impl shame::TextureFormatId {
        ExtendedTextureFormats::SurfaceFormat
    }
}
...
impl sm::TextureFormatId for ExtendedTextureFormats {
    fn to_binary_repr(&self) -> Cow<[u8]> {
        b"SurfaceFormat".into()
    }

    fn to_wgsl_repr(&self) -> Option<Cow<str>> {
        None
    }
    ...
    fn has_aspect(&self, aspect: sm::TextureAspect) -> bool {
        aspect == sm::TextureAspect::Color
    }
